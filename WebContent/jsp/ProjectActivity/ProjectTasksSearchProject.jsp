            	 	...
            	 	<div class="section">
	                    ...
	                    <div style="position: relative; margin-top: 20px; margin-left: 10px">
						    ...
						    <tr>
								...
								<td>	
									  		<a href="/twobSceneWebApp/projectTasks/addProjectActivity.action?selectedProjectID=<s:property value="projectID"/>&selectedProjetName=<s:property value="projectName"/>">
