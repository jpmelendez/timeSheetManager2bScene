	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-2">
        	...
        	<div class="form-header header-primary">
            	<h4><i class="fa fa-pencil-square"></i>Edit Task</h4>
            </div><!-- end .form-header section -->
            
            <form method="post" action="updateTask" id="smart-form">
            <s:hidden  value="%{selectedStageName}" name="selectedStageName" />
            <s:hidden  value="%{taskById.stageID}" name="selectedStageID" />
            <s:hidden  value="%{taskById.taskID}" name="taskID" />
            <s:hidden  value="%{taskById.stageID}" name="stageID" />
            	<div class="form-body">
                	...
                	<div class="section">
                    	<label for="taskName" class="field prepend-icon">
                        	<input type="text" name="taskName" id="taskName" class="gui-input" placeholder="Task name" value="<s:property value="taskById.taskName" />">
                    ...
                    <div class="section">
                    	<label for="taskDescription" class="field prepend-icon">
                        	<textarea class="gui-textarea" id="taskDescription" name="taskDescription" placeholder="Task Description"><s:property value="taskById.taskDescription" /></textarea>
                    ...
                    <div class="section">
                    	<label for="taskPriority" class="field prepend-icon">
                        	<input type="text" name="taskPriority" id="taskPriority" class="gui-input" placeholder="Order Of Priority" value="<s:property value="taskById.taskPriority" />">
                            <span class="field-icon"><i class="fa fa-envelope"></i></span>  
                        </label>
                    </div><!-- end section -->
                ...
                <div class="form-footer">
                	<button type="submit" class="button btn-primary" value="updateTask"> Save </button>
