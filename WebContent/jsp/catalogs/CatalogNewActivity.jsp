	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-2">
        	...
        	<div class="form-header header-primary">
            	<h4><i class="fa fa-pencil-square"></i>New Activity</h4>
            </div><!-- end .form-header section -->
            
            <form method="post" action="addActivity" id="smart-form">
			...
			<s:hidden  value="0" name="actChecked" />
            	<div class="form-body">
                	...
                	<div class="section">
                    	<label for="actName" class="field prepend-icon">
                        	<input type="text" name="actName" id="actName" class="gui-input" placeholder="Activity name">
                    ...
                    <div class="section">
                    	<label for="actDescription" class="field prepend-icon">
                        	<textarea class="gui-textarea" id="actDescription" name="actDescription" placeholder="Activity Description"></textarea>
                    ...
                    <div class="section">
                    	<label for="actPriority" class="field prepend-icon">
                        	<input type="text" name="actPriority" id="actPriority" class="gui-input" placeholder="Order Of Priority">
                            <span class="field-icon"><i class="fa fa-envelope"></i></span>  
                        </label>
                    </div><!-- end section -->
                    ...
                    <div class="section">
			                   ...
			                   <s:checkbox name="actAlert" id="actAlert" value="0" ></s:checkbox>
                              
                              <span> Set activity alert </span>
                ...
                <div class="form-footer">
                	<button type="submit" class="button btn-primary" value="addActivity"> Save </button>
