	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-2">
        	...
        	<div class="form-header header-primary">
            	<h4><i class="fa fa-pencil-square"></i>New Staff</h4>
            </div><!-- end .form-header section -->
            
            <form action="addStaff" method="post" id="register-form" >
                   ...
                   <div class="frm-row">
                    ...
                    <div class="section">
                    	<label for="address" class="field prepend-icon">
                        	<textarea class="gui-textarea" id="address" name="address" placeholder="Address"></textarea>
                     ...
                     <div class="section">
                    	<label for="mobile_phone" class="field prepend-icon">
                                <input type="text" name="phone" id="phone" class="gui-input phone-group" placeholder="Ph. Number">
                    ...
                    <div class="frm-row">
                        <div class="section colm colm6">
                            <label for="initials" class="field prepend-icon">
                                <input type="text" name="initials" id="initials" class="gui-input" placeholder="Name Initials...">
                                <span class="field-icon"><i class="fa fa-user"></i></span>  
                            </label>
                        </div><!-- end section -->
                    ...
                    <div class="frm-row">
                       <div class="section colm colm6">
                            ...
                            <label class="field sfcolor">
                            	<input type="text" name="colorCode" value="#ff0000" id="typepicker" class="gui-input">
                            </label>
                        </div><!-- end section -->
                ...
                <div class="form-footer">
                	<button type="submit" class="button btn-primary" value="addStaff"> Save </button>
